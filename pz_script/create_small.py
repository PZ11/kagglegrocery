...
train_small = train.loc[(train.item_nbr==103501),]
...
test_small = test.loc[(test.item_nbr==103501),]

#Write File
test_small.to_csv('../input/test_small.csv', index=False)
train_small.to_csv('../input/train_small.csv', index=False)
