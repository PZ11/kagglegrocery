...
if param_1 == "1s":
    train_out.to_pickle('../data/T40_train_storeitem_1s.p')
    val_out.to_pickle('../data/T40_val_storeitem_1s.p')
    X_test.to_pickle('../data/T40_test_storeitem_1s.p')
    
else:
    train_out.to_pickle('../data/T40_train_storeitem.p')
    val_out.to_pickle('../data/T40_val_storeitem.p')
    X_test.to_pickle('../data/T40_test_storeitem.p')
