...
def prepare_dataset(t2017, is_train=True):
    X = pd.DataFrame({
       ...
       # "mean_ly_wk2_2017": get_timespan(df_2017, t2017, 364, 14).mean(axis=1).values,        
        ...
        "mean_ly_1d_2017": get_timespan(df_2017, t2017, 364, 1).mean(axis=1).values,
...
# Calculate the ratio of the same day last year 
X_train["mean_ly_1d_2017"] = X_train["mean_ly_1d_2017"] * 364 / X_train["mean_364_2017"]
...
submission.to_csv('../submit/T026_tmp.csv', float_format='%.4f', index=None)
...
submission.to_csv('../submit/T026_moreLY.csv.gz',
