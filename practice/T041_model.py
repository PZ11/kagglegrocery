...
if  ((param_1 == "1ss") or (param_1 == "1s")):
    ...
    train_out = pd.read_pickle('../data/T40_train_storeitem.p')
    val_out = pd.read_pickle('../data/T40_val_storeitem.p')
    X_test_out = pd.read_pickle('../data/T40_test_storeitem.p')
