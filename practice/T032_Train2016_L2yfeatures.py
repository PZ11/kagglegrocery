...
if param_1 == "val":
    ...
    test_e.to_pickle('../data/V030_val.p')

    # items = items.reset_index()
    # test = pd.merge(test_e, items, on='item_nbr', how='inner')

    # del valid, pred, test_e

    # eval_test(test[['unit_sales', 'pred_sales', 'date', 'perishable']])
...
# Submit
    ...
    submission.to_csv('../submit/T032_train2016.csv.gz',
