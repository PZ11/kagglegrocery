...
df_dis = df_train_maxdate.loc[df_train_maxdate['max_date'] <= '2017-07-15',]
...
df_sub.to_csv('../input/sub_zero_30d.csv', float_format='%.4f', index=None)
...
submission.to_csv('../submit/T019_zero_30d.csv.gz', float_format='%.4f', index=None, compression='gzip')
