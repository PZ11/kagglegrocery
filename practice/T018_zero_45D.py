...
df_dis = df_train_maxdate.loc[df_train_maxdate['max_date'] <= '2017-07-01',]
...
df_sub.to_csv('../input/sub_zero_45d.csv', float_format='%.4f', index=None)
...
submission.to_csv('../submit/T018_zero_45d.csv.gz', float_format='%.4f', index=None, compression='gzip')
